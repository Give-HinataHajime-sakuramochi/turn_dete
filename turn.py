...
# global variable
# 鳥瞰取點
# pts1 = np.int32([[1100, 900], [600, 1225], [1375, 900], [1900, 1225]])

# pts1 = np.int32([[1280-200, 900], [1280-800, 1225], [1280+200, 900], [1280+800, 1225]])



pts1=np.float32([[1280-200, 900], [1280-800, 1225], [1280+200, 900], [1280+800, 1225]]) #左上、左下、右上、右下
...
def draw_lines(img, lines, color=[255, 0, 0], thickness=5):
    ...
    if average_left_slope and average_right_slope:
...
while cap.isOpened():
    ...
    cv2.namedWindow("t1", 0)
    cv2.resizeWindow("t1", 700, 480)
    cv2.imshow("t1", b_img)
    #cv2.waitKey(1)q
